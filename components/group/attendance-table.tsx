    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex justify-end gap-2 pt-4 border-t border-border">
        ...
        <Button onClick={handleSave} disabled={isSaving}>
          ...
          {/* Leaders Tab */}
          <TabsContent value="leaders" className="space-y-4 sm:space-y-6 mt-4">
            <Card className="p-4 sm:p-6">
              <h3 className="text-lg font-semibold mb-4">Leader Attendance</h3>
              
              {leaders.length === 0 ? (
                <p className="text-center text-muted-foreground py-8">
                  No leaders added yet. Add leaders from Settings → Leaders tab.
                </p>
              ) : (
                <>
                  {/* Desktop Table */}
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b">
                          ...
                          <th className="text-center p-3 bg-blue-50 dark:bg-blue-900/30">Total (0-10)</th>
                        </tr>
                      </thead>
                      <tbody>
                        {leaders.map((leader) => (
                          <tr key={leader.email} className="border-b hover:bg-muted/30">
                            <td className="p-3 font-medium">{leader.rollNo}</td>
                              ...
                              <Select 
                                ...
                                onValueChange={(value) => {
                                  const updated = leaders.map(l =>
                                    l.email === leader.email ? {...l, status: value} : l
                                  );
                                  setLeaders(updated);
                                }}
                              >
                            ...
                            <td className="p-3 text-center bg-blue-50 dark:bg-blue-900/30">
                              <span className="text-lg font-bold text-blue-600 dark:text-blue-400">{leader.totalMarks}</span>
                            </td>
                          </tr>
                        ))}
                      </tbody>
                      ...
                      <Card key={leader.email} className="p-4">
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xl font-bold text-blue-600">{leader.totalMarks}/10</span>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <div>
                              <label className="text-xs font-medium mb-1 block">Attendance (0-5)</label>
                              <Input
                                type="number"
                                min="0"
                                max="5"
                            ...
                            <div>
                              <label className="text-xs font-medium mb-1 block">Judge (0-5)</label>
                              <Input
                                type="number"
                                min="0"
                                max="5"
        ...
        /* If not teacher, show students without tabs */
        <div className="space-y-4 sm:space-y-6">
          {/* Students Content - Same as TabsContent but without tabs */}
          <Card className="p-3 sm:p-4">
            <div className="flex flex-col gap-3">
              {/* Branch Filter */}
              {availableBranches.length > 0 && (
